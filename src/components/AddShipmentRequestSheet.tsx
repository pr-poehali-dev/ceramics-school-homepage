...
const AddShipmentRequestSheet = ({ open, onOpenChange }: Props) => {
      ...
      <SheetContent side="bottom" className="max-h-[92vh] overflow-y-auto rounded-t-3xl sm:mx-auto sm:max-w-lg">
        {done ? (
          <div className="flex flex-col items-center py-8 text-center">
            ...
            <Button className="mt-6 rounded-full" onClick={() => onOpenChange(false)}>
              Понятно
            </Button>
          </div>
        ) : (
          <>
            <SheetHeader>
              <SheetTitle>Добавить посылку</SheetTitle>
              <SheetDescription>
                Не нашли свою посылку в системе? Оставьте заявку с фото изделия — мы найдём её и
                подключим к отслеживанию.
              </SheetDescription>
            </SheetHeader>
...
export default AddShipmentRequestSheet;

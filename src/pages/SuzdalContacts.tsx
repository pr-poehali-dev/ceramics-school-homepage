...
const SuzdalContacts = () => {
  usePageMeta({
    title: 'Контакты фабрики и школы «Дымов Керамика» в Суздале',
    description:
      'Контакты фабрики и школы керамики «Дымов Керамика» в Суздале: адрес, телефон, e-mail и график работы. Владимирская область, г. Суздаль, ул. Васильевская, 41а.',
  });

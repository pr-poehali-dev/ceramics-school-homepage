...
const Suzdal = () => {
  usePageMeta({
    title: 'Школа керамики в Суздале «Дымов Керамика»',
    description:
      'Фабрика и школа керамики в Суздале ждёт в гости детей и взрослых! Мастер-классы, экскурсии по фабрике, курсы и праздники.',
  });
  return (

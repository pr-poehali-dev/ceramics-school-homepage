...
export const PAGE_SCHEMAS: PageSchema[] = [
  ...
  // MOSCOW — мастер-классы (карточки внутри)
  {
    ...
    fields: [
      ...
      { key: 'formatsBannerTitle', label: 'Баннер «Формат для праздника» — заголовок', type: 'text' },
      { key: 'formatsBannerText', label: 'Баннер «Формат для праздника» — текст', type: 'textarea' },
      { key: 'askBannerTitle', label: 'Баннер «Не знаете, что выбрать?» — заголовок', type: 'text' },
      { key: 'askBannerText', label: 'Баннер «Не знаете, что выбрать?» — текст', type: 'textarea' },
      { key: 'askBannerButtonText', label: 'Баннер «Не знаете, что выбрать?» — текст кнопки', type: 'text' },
      { key: 'seoTitle', label: 'SEO-текст — заголовок', type: 'text' },
      { key: 'seoParagraphs', label: 'SEO-текст — вступительные абзацы (каждый с новой строки)', type: 'textarea' },
      { key: 'seoListTitle', label: 'SEO-текст — заголовок списка «Что вас ждёт»', type: 'text' },
      { key: 'seoListItems', label: 'SEO-текст — список «Что вас ждёт» (каждый пункт с новой строки)', type: 'textarea' },
      { key: 'seoStagesIntro', label: 'SEO-текст — фраза перед списком этапов', type: 'text' },
      { key: 'seoStagesList', label: 'SEO-текст — список этапов занятия (каждый пункт с новой строки)', type: 'textarea' },
      { key: 'seoClosing', label: 'SEO-текст — заключительный абзац', type: 'textarea' },
    ],
    defaults: {
      ...
      formatsBannerTitle: 'Ищете формат для праздника или мероприятия?',
      formatsBannerText: 'Дни рождения, корпоративы, свидания и другие форматы на базе мастер-классов.',
      askBannerTitle: 'Не знаете, что выбрать?',
      askBannerText: 'Напишите нам — подскажем формат под ваш возраст, компанию и повод.',
      askBannerButtonText: 'Задать вопрос',
      seoTitle: 'Мастер-классы по гончарному искусству',
      seoParagraphs:
        'Каждый день в стенах школы «Дымов Керамика» дети и взрослые познают гончарное ремесло, осуществляют свои творческие идеи и создают авторские изделия из глины.\nВ уютной мастерской школы каждый найдёт себе занятие по душе. Нашими участниками становятся малыши возрастом от 3 лет, школьники и учащиеся, взрослые любого возраста.\nОпытные мастера научат всех желающих гончарному ремеслу, ручной лепке, техникам росписи керамических изделий. Помогут каждому раскрыться в творчестве и создать собственное неповторимое изделие.\nВ мастерской можно отпраздновать торжество, отметить день рождения, девичник или другой праздник.\nВ Школе гости могут не только провести время с семьёй или друзьями, отдохнуть и познакомиться с керамикой, но и овладеть ремеслом на высоком уровне.',
      seoListTitle: 'Что вас ждёт на мастер-классах в школе «Дымов Керамика»:',
      seoListItems:
      ...
      seoStagesIntro: 'Занятия состоят из нескольких этапов:',
      seoStagesList: 'Подготовка глины к работе\nЦентровка материала на гончарном круге\nСоздание изделия симметричной формы\nЛепка декоративных элементов',
      seoClosing:
        'После окончания занятия созданное вами изделие ждёт просушка и обжиг в печи. Через 2 недели вы сможете забрать своё творение домой или насладиться росписью изделия под чутким руководством опытного наставника.',
    },
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'h1', label: 'Заголовок H1', type: 'text' },
      { key: 'subtitle', label: 'Подзаголовок под H1', type: 'textarea' },
      { key: 'ctaTitle', label: 'Баннер «Не нашли формат?» — заголовок', type: 'text' },
      { key: 'ctaText', label: 'Баннер «Не нашли формат?» — текст', type: 'textarea' },
      { key: 'ctaButtonText', label: 'Баннер «Не нашли формат?» — текст кнопки', type: 'text' },
      { key: 'seoTitle', label: 'SEO-текст — заголовок', type: 'text' },
      { key: 'seoIntro', label: 'SEO-текст — вступительный абзац', type: 'textarea' },
      { key: 'seoWhoTitle', label: 'SEO-текст — подзаголовок «Кому подходит»', type: 'text' },
      { key: 'seoWhoText', label: 'SEO-текст — текст «Кому подходит»', type: 'textarea' },
      { key: 'seoFormatsTitle', label: 'SEO-текст — подзаголовок «Все форматы занятий»', type: 'text' },
      { key: 'seoFormatsList', label: 'SEO-текст — форматы (Заголовок|Текст, каждый пункт с новой строки)', type: 'textarea' },
      { key: 'seoHowTitle', label: 'SEO-текст — подзаголовок «Как выбрать и забронировать»', type: 'text' },
      { key: 'seoHowText1', label: 'SEO-текст — «Как выбрать» абзац 1', type: 'textarea' },
      { key: 'seoHowText2', label: 'SEO-текст — «Как выбрать» абзац 2', type: 'textarea' },
    ],
    defaults: {
      ...
      ctaText: 'Напишите — подберём индивидуальный вариант под вашу группу, повод и бюджет.',
      ctaButtonText: 'Написать нам',
      seoTitle: 'Форматы мастер-классов в «Дымов Керамика»: выберите свой идеальный вариант',
      seoIntro:
        'Страница «Форматы» — это витрина возможностей школы керамики на ВДНХ. Здесь каждый, от ребёнка до взрослого, найдёт свой способ прикоснуться к гончарному искусству. За 20 лет мы поняли: универсального решения нет — кому-то нужен быстрый мастер-класс, а кто-то готов посвятить ремеслу целый день. Поэтому мы создали гибкую систему форматов: от классических занятий до камерных свиданий и масштабных корпоративов.',
      seoWhoTitle: 'Кому подходит обучение в гончарной мастерской?',
      seoWhoText:
        '«Дымов Керамика» — пространство, где творчество доступно всем. Мы принимаем малышей с 3 лет (вместе с родителями), школьников, студентов и взрослых. Мастера помогают раскрыть потенциал каждому, учат ручной лепке, работе на гончарном круге и росписи ангобами. В уютной студии на ВДНХ вы не просто проведёте время — уйдёте с авторским изделием, сделанным своими руками.',
      seoFormatsTitle: 'Все форматы занятий',
      seoFormatsList:
        '1. Классические и групповые мастер-классы|Базовый формат для знакомства с глиной — 1 час, группы до 20 человек. Выбирайте детскую группу по выходным (3–10 лет) или промо-тарифы в будни (от 7 лет).\n2. Тематические и расширенные форматы|Для углублённого погружения: тематические МК до 6,5 часов (от 12 лет), коворкинг с поминутной оплатой для самостоятельной работы и романтическое свидание в мастерской на 1,5 часа для двоих.\n3. Праздники в «Дымов Керамика»|Мы специалисты по нестандартным торжествам: дни рождения для детей, корпоративы вместо скучных банкетов, девичники и мальчишники. Проводим в студии на ВДНХ или с выездом к вам.\n4. Выездной мастер-класс|Приедем в офис, школу или загородный клуб. От 30 минут, для 1–100 человек, с полным набором материалов и инструментов.',
      seoHowTitle: 'Как выбрать и забронировать?',
      seoHowText1:
        'Ориентируйтесь на количество человек, возраст и желаемое время. Не нашли идеальный вариант? Оставьте заявку — мы подберём индивидуальный формат под ваш бюджет и повод.',
      seoHowText2:
        'Приходите в «Дымов Керамика» на ВДНХ, чтобы отвлечься от рутины, научиться новому и подарить себе и близким настоящий творческий вечер.',
    },
  },
  {
    ...
    fields: [
      ...
      { key: 'previewLocation', label: 'Превью сертификата — локация', type: 'text' },
      { key: 'validityText', label: 'Превью — срок действия', type: 'text' },
      { key: 'perk1Text', label: 'Преимущество 1 — текст', type: 'text' },
      { key: 'perk2Text', label: 'Преимущество 2 — текст', type: 'text' },
      { key: 'faqItems', label: 'FAQ (Вопрос|Ответ, каждый пункт с новой строки)', type: 'textarea' },
      { key: 'seoTitle', label: 'SEO-текст — заголовок', type: 'text' },
      { key: 'seoParagraph1', label: 'SEO-текст — абзац 1', type: 'textarea' },
      { key: 'seoParagraph2', label: 'SEO-текст — абзац 2', type: 'textarea' },
      { key: 'seoWhatTitle', label: 'SEO-текст — подзаголовок «Что представляет собой»', type: 'text' },
      { key: 'seoWhatText', label: 'SEO-текст — текст «Что представляет собой»', type: 'textarea' },
      { key: 'seoDirectionsIntro', label: 'SEO-текст — фраза перед списком направлений', type: 'text' },
      { key: 'seoDirectionsList', label: 'SEO-текст — список направлений (каждый пункт с новой строки)', type: 'textarea' },
      { key: 'seoClosing', label: 'SEO-текст — заключительный абзац про свидания', type: 'textarea' },
      { key: 'seoTypesTitle', label: 'SEO-текст — подзаголовок «Какими бывают сертификаты»', type: 'text' },
      { key: 'seoTypesText', label: 'SEO-текст — текст «Какими бывают сертификаты»', type: 'textarea' },
      { key: 'seoExamplesIntro', label: 'SEO-текст — фраза перед примерами сертификатов', type: 'text' },
      { key: 'seoExamplesList', label: 'SEO-текст — примеры сертификатов (каждый пункт с новой строки)', type: 'textarea' },
    ],
    defaults: {
      ...
      previewLocation: 'Студия керамики · ВДНХ, Москва',
      validityText: 'Срок действия: 6 месяцев',
      perk1Text: 'Отправим на e-mail сразу после оплаты',
      perk2Text: 'Действует 6 месяцев с момента покупки',
      faqItems:
        'Как получить сертификат?|После оформления и оплаты сертификат придёт на вашу электронную почту в течение нескольких минут.\nМожно ли использовать сертификат частями?|Да, сертификат можно использовать на несколько посещений, пока не закончится сумма. Срок действия при этом не продлевается.\nЧто если занятие стоит больше номинала?|Разницу можно доплатить на месте. Мы примем наличные или карту.\nМожно ли вернуть сертификат?|Да, неиспользованный сертификат можно вернуть в течение 14 дней с момента покупки.',
      seoTitle: 'Подарочные сертификаты «Дымов Керамика»',
      seoParagraph1:
        'Школа гончарного мастерства «Дымов Керамика» предлагает вам порадовать своих близких оригинальным и запоминающимся подарком. Подарочный сертификат на уроки гончарного мастерства станет приятным сюрпризом даже для тех людей, которых, казалось бы, нечем удивить. Незабываемые часы, проведённые в гончарной мастерской, позволят зажечь огонь в глазах именинника, пробудить в нём интерес и творческий потенциал, здоровый азарт и детский восторг.',
      seoParagraph2:
        'Кроме того, сертификат «Дымов Керамика» даёт возможность не только интересно, но и полезно провести время. Работа с глиной — это, в первую очередь, отличный релакс, позволяющий отвлечься от будничных забот и проблем, успокоить нервную систему и развить творческие способности. К тому же, лепка и работа с гончарным кругом тренирует мелкую моторику рук, координацию движений и способность концентрировать своё внимание (что полезно и детям, и взрослым).',
      seoWhatTitle: 'Что представляет собой подарочный сертификат по гончарному делу?',
      seoWhatText:
        'Подарочный сертификат «Дымов Керамика» — это интересный и необычный подарок на все случаи жизни. Такой презент приятно удивит именинника своей оригинальностью и не банальностью, а также подчеркнёт хороший вкус дарителя. Немаловажно и то, что подарку будут рады как взрослые, так и дети (у нас есть программы и для малышей от 4 лет, и для школьников младших, средних или старших классов).\nСертификат представляет собой своеобразный пропуск в мир гончарного искусства.',
      seoDirectionsIntro: 'В соответствии с выбранным направлением, можно будет:',
      seoDirectionsList:
      ...
      seoClosing:
        'Сертификат может быть использован как для занятий в группе, так и для закрытых, индивидуальных мероприятий. К примеру, сертификат может стать прекрасным подарком для влюблённых, которые проведут в нашей мастерской незабываемое свидание в атмосфере творчества, романтики и уединения.',
      seoTypesTitle: 'Какими бывают подарочные сертификаты «Дымов Керамика»?',
      seoTypesText:
        'Подарочные сертификаты «Дымов Керамика» действительны в течение года с момента продажи и открывают для своего владельца удивительные возможности. Вы можете порадовать именинника сертификатом на участие в определённом мастер-классе (на ваш выбор) или предоставить дорогому вам человеку право самому выбрать направление для творчества. Сертификаты с открытой суммой позволяют своему счастливому обладателю участвовать в нескольких мастер-классах или посещать те занятия, которые ему наиболее интересны.',
      seoExamplesIntro: 'Так, к примеру, вы сможете приобрести следующие сертификаты «Дымов Керамика»:',
      seoExamplesList:
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'carEntranceTitle', label: 'Блок «На машине» — заголовок 1', type: 'text' },
      { key: 'carEntranceText', label: 'Блок «На машине» — текст 1', type: 'textarea' },
      { key: 'carExitTitle', label: 'Блок «На машине» — заголовок 2', type: 'text' },
      { key: 'carExitText', label: 'Блок «На машине» — текст 2', type: 'textarea' },
      { key: 'busRouteText', label: 'Блок «На транспорте» — маршрут автобуса', type: 'text' },
      { key: 'busToOneText', label: 'Блок «На транспорте» — остановка 1', type: 'textarea' },
      { key: 'busToTwoText', label: 'Блок «На транспорте» — остановка 2', type: 'textarea' },
      { key: 'busFirstTime', label: 'Блок «На транспорте» — первый автобус', type: 'text' },
      { key: 'busLastTime', label: 'Блок «На транспорте» — последний автобус', type: 'text' },
    ...
    defaults: {
      ...
      mapEmbedUrl:
        'https://yandex.ru/map-widget/v1/?mode=search&text=%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0%2C%20%D0%BF%D1%80%D0%BE%D1%81%D0%BF%D0%B5%D0%BA%D1%82%20%D0%9C%D0%B8%D1%80%D0%B0%2C%20119%D1%81186&z=17',
      carEntranceTitle: 'Въезд Лихоборский',
      carEntranceText:
        'Со стороны Сельскохозяйственной улицы, после 21 дома. Далее через въезд, по прямой до перекрёстка с кольцевой дорогой — налево, строение 186.',
      carExitTitle: 'Выезд Совхозный',
      carExitText:
        'Со стороны Сельскохозяйственной улицы, после 19 дома. Далее через выезд, по прямой до перекрёстка с кольцевой дорогой — направо, строение 186.',
      busRouteText: 'Автобус №533 — «Метро ВДНХ» → «Метро Ботанический сад» по территории ВДНХ.',
      busToOneText: '→ к «Ботанический сад»: остановка «Павильон № 57 — Исторический парк Россия — Моя история».',
      busToTwoText: '→ к «ВДНХ»: остановка «Городская ферма» или «Дворец бракосочетания».',
      busFirstTime: '07:00 от ВДНХ',
      busLastTime: '23:20 от Ботанического сада',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'pickupFormButtonText', label: 'Блок «Выдача» — кнопка «Заполнить форму»', type: 'text' },
      { key: 'pickupTrackButtonText', label: 'Блок «Выдача» — кнопка «Отследить статус»', type: 'text' },
    ...
    defaults: {
      ...
      pickupIntro:
        'Вы прошли мастер-класс в Школе керамики на ВДНХ? Чтобы отслеживать готовность своего изделия и вовремя забрать его, выполните несколько шагов:',
      pickupSteps:
        'По окончании мастер-класса заполните короткую форму на странице отслеживания — укажите ФИО, телефон, email и приложите фото изделия.\nСтатус изделия можно узнать по номеру телефона на странице отслеживания в любой момент.\nКак только изделие пройдёт обжиг, на указанный email придёт письмо о том, что изделие готово и можно приезжать забирать.',
      pickupFormButtonText: 'Заполнить форму',
      pickupTrackButtonText: 'Отследить статус',
      pickupNoteAfterPhone: 'Готовое изделие можно забрать по адресу:',
      pickupPhotoNote: 'Изделие выдаётся по фотографии.',
      pickupStorageNote: 'Мы бережно храним ваши изделия в течение 2 месяцев с даты оформления заявки.',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'localPickupNote', label: 'Блок «Забрать в Суздале» — текст', type: 'textarea' },
      { key: 'pickupIntro', label: 'Блок «Выдача» — вводный текст', type: 'textarea' },
      { key: 'pickupSteps', label: 'Блок «Выдача» — шаги инструкции (каждый с новой строки)', type: 'textarea' },
      { key: 'pickupFormButtonText', label: 'Блок «Выдача» — кнопка «Заполнить форму»', type: 'text' },
      { key: 'pickupTrackButtonText', label: 'Блок «Выдача» — кнопка «Отследить статус»', type: 'text' },
      ...
      { key: 'pickupPhotoNote', label: 'Блок «Выдача» — «Изделие выдаётся по фотографии»', type: 'text' },
      { key: 'pickupStorageNote', label: 'Блок «Выдача» — срок хранения изделий', type: 'text' },
      { key: 'pickupWarning', label: 'Блок «Выдача» — важно отслеживать статус', type: 'textarea' },
      { key: 'pickupFootnote', label: 'Блок «Выдача» — сноска про утилизацию', type: 'textarea' },
    ],
    defaults: {
      metaTitle: 'Информация об отправке и выдаче изделий | Дымов Керамика, Суздаль',
      metaDescription:
        'Информация об отправке готовых изделий из Суздаля в Москву и условиях их выдачи после мастер-класса в школе керамики «Дымов Керамика». Срок хранения и правила получения.',
      h1: 'Полезная информация',
      subtitle: 'Отправка готовых изделий в Москву и условия их выдачи после мастер-класса в Суздале.',
      phone: '+7 (985) 419-89-03',
      address: 'ВДНХ, проспект Мира, 119, строение 186',
      workHours: 'Ежедневно с 11:00 до 20:00',
      deliveryText1:
      ...
      deliveryText2After: 'либо через страницу отслеживания на сайте.',
      localPickupNote:
        'В редких случаях изделие можно забрать прямо в Суздале, если вы остаётесь в городе достаточно долго и обжиг успевает завершиться до вашего отъезда — уточните эту возможность у мастера сразу после мастер-класса.',
      pickupIntro:
        'Вы прошли мастер-класс в школе керамики в Суздале? Чтобы отслеживать готовность своего изделия и вовремя забрать его, выполните несколько шагов:',
      pickupSteps:
        'По окончании мастер-класса заполните короткую форму на странице отслеживания — укажите ФИО, телефон, email и приложите фото изделия.\nСтатус изделия можно узнать по номеру телефона на странице отслеживания в любой момент.\nПосле обжига изделие отправляется в Москву на ВДНХ; как только оно прибудет и будет готово к выдаче, на указанный email придёт письмо с адресом и часами работы.',
      pickupFormButtonText: 'Заполнить форму',
      pickupTrackButtonText: 'Отследить статус',
      pickupNoteAfterPhone: 'Готовое изделие можно забрать в Москве по адресу:',
      pickupPhotoNote: 'Изделие выдаётся по фотографии.',
      pickupStorageNote: 'Мы бережно храним изделие в течение 60 дней с момента его прибытия в школу керамики на ВДНХ.',
      pickupWarning:
        'Пожалуйста, внимательно отслеживайте статус изделия на странице отслеживания — срок хранения отсчитывается от даты прибытия в Москву, а не от даты мастер-класса в Суздале.',
      pickupFootnote: 'По истечении 60 дней хранения мы оставляем за собой право утилизировать изделие либо передать его на благотворительную ярмарку.',
    },
  },
  {
    key: 'moscow-offer',
  ...
  // SUZDAL
  {
    ...
    defaults: {
      ...
      askBannerText: 'Напишите нам — подскажем формат под ваш возраст, компанию и повод.',
      askBannerButtonText: 'Задать вопрос',
      seoTitle: 'Мастер-классы по гончарному искусству в Суздале',
      seoParagraphs:
        'Каждый день на фабрике и в школе «Дымов Керамика» в Суздале гости познают гончарное ремесло, осуществляют свои творческие идеи и создают авторские изделия из глины.\nВ уютной мастерской каждый найдёт себе занятие по душе. Нашими участниками становятся малыши, школьники и взрослые любого возраста.\nОпытные мастера научат всех желающих гончарному ремеслу, ручной лепке, техникам росписи керамических изделий и изготовлению изразцов. Помогут каждому раскрыться в творчестве и создать собственное неповторимое изделие.',
      seoListTitle: 'Что вас ждёт на мастер-классах в школе «Дымов Керамика»:',
      seoListItems:
      ...
      seoClosing:
        'После окончания занятия созданное вами изделие ждёт просушка и обжиг. Готовое изделие можно забрать в мастерской в Суздале или на ВДНХ в Москве — как только его доставят (в течение 60 дней), вы будете оповещены по телефону.',
    },
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'bookingTitle', label: 'Блок «Запись по телефону» — заголовок', type: 'text' },
      { key: 'bookingTextBefore', label: 'Блок «Запись по телефону» — текст перед номером', type: 'text' },
      { key: 'bookingTextAfter', label: 'Блок «Запись по телефону» — текст после номера', type: 'text' },
      { key: 'previewLocation', label: 'Превью сертификата — локация', type: 'text' },
      { key: 'validityText', label: 'Превью — срок действия', type: 'text' },
      { key: 'perk1Text', label: 'Преимущество 1 — текст (возраст)', type: 'text' },
      { key: 'perk2Text', label: 'Преимущество 2 — текст (длительность)', type: 'text' },
      { key: 'perk3Text', label: 'Преимущество 3 — текст (срок действия)', type: 'text' },
      { key: 'aboutText', label: 'Блок «О сертификате» — абзацы (каждый с новой строки)', type: 'textarea' },
      { key: 'aboutHighlight', label: 'Блок «О сертификате» — выделенная фраза', type: 'text' },
      { key: 'footnotes', label: 'Сноски внизу (каждая с новой строки)', type: 'textarea' },
    ],
    defaults: {
      ...
      bookingTitle: 'Запись по телефону',
      bookingTextBefore: 'Запись на мастер-классы только по телефону',
      bookingTextAfter: 'Оплата на месте картой или наличными.',
      previewLocation: 'Фабрика и школа · Суздаль',
      validityText: 'Срок действия: 6 месяцев',
      perk1Text: 'Для участников любого возраста (кроме сертификата для детской группы)',
      perk2Text: 'Продолжительность занятия — от 1 часа',
      perk3Text: 'Сертификат действителен в течение 6 месяцев',
      aboutText:
        'Подарки могут быть разными. Особенно хороши подарки, сделанные с душой. Мы в школе «Дымов Керамика» вкладываем душу в каждого ученика.\nДарите приятные эмоции близким и друзьям! Ждём вас в нашей школе гончарного искусства «Дымов Керамика» в Суздале.\nТакже подарочные сертификаты можно приобрести в магазине «Дымов Керамика» (Суздаль, Транспортная улица, 9).',
      aboutHighlight: 'Преподнесите в подарок занятие в школе «Дымов Керамика»!',
      footnotes:
        '*Абонемент действителен 3 месяца с момента приобретения.\n*Подарочный сертификат действителен в течение 6 месяцев.\n*Вы всегда можете заказать бумажную версию сертификата. Курьерская доставка оплачивается дополнительно.',
    },
  },
  {
  ...
  },
  {
    ...
    fields: [
      { key: 'whatsappLink', label: 'WhatsApp — ссылка (пусто = скрыть иконку)', type: 'text' },
      { key: 'telegramLink', label: 'Telegram — ссылка на профиль (пусто = скрыть иконку)', type: 'text' },
      { key: 'maxLink', label: 'MAX — ссылка на профиль (пусто = скрыть иконку)', type: 'text' },
      { key: 'preferredLabel', label: 'Подсказка рядом с иконкой мессенджеров (пусто = не показывать)', type: 'text' },
      { key: 'outageNotice', label: 'Предупреждение о перебоях (например: «WhatsApp работает с перебоями, пишите в Telegram»). Пусто = не показывать', type: 'text' },
    ],
  ...
  },
  {
    ...
    fields: [
      { key: 'metaTitle', label: 'Title (для поисковиков)', type: 'text' },
      { key: 'metaDescription', label: 'Description (для поисковиков)', type: 'textarea' },
      { key: 'badgeText', label: 'Метка над заголовком', type: 'text' },
      { key: 'findTitle', label: 'Вкладка «Найти» — заголовок', type: 'text' },
      { key: 'findTitleHighlight', label: 'Вкладка «Найти» — выделенное слово в заголовке', type: 'text' },
      { key: 'findSubtitle', label: 'Вкладка «Найти» — вводный текст', type: 'textarea' },
      { key: 'findNoticeEnabled', label: 'Вкладка «Найти» — показывать жёлтое уведомление', type: 'boolean' },
      { key: 'findNotice', label: 'Вкладка «Найти» — текст в жёлтом уведомлении', type: 'textarea' },
      { key: 'addTitle', label: 'Вкладка «Добавить» — заголовок', type: 'text' },
      { key: 'addTitleHighlight', label: 'Вкладка «Добавить» — выделенное слово в заголовке', type: 'text' },
      { key: 'addSubtitle', label: 'Вкладка «Добавить» — вводный текст', type: 'textarea' },
      { key: 'addNoticeEnabled', label: 'Вкладка «Добавить» — показывать жёлтое уведомление', type: 'boolean' },
      { key: 'addNotice', label: 'Вкладка «Добавить» — текст в жёлтом уведомлении', type: 'textarea' },
      { key: 'notFoundText', label: 'Текст «ничего не найдено»', type: 'text' },
      { key: 'suzdalPhone', label: 'Телефон Суздаля (в результатах поиска)', type: 'text' },
      { key: 'moscowPhone', label: 'Телефон Москвы (в результатах поиска)', type: 'text' },
      { key: 'photoHint', label: 'Форма заявки — подсказка про фото', type: 'text' },
    ],
    defaults: {
      metaTitle: 'Отследить готовое изделие — «Дымов Керамика»',
      metaDescription: 'Узнайте статус вашего готового керамического изделия по номеру телефона.',
      badgeText: 'Отслеживание готовых работ',
      findTitle: 'Где моё',
      findTitleHighlight: 'изделие?',
      findSubtitle: 'Введите номер телефона — покажем статус изделий из Суздаля и Москвы.',
      findNoticeEnabled: 'true',
      findNotice:
        'Отследить можно изделия, уже добавленные менеджером Суздаля в систему, и заявки, оформленные в Москве. Если изделие сделано в Суздале, но менеджер ещё не успел его добавить — свяжитесь с нами напрямую.',
      addTitle: 'Добавить',
      addTitleHighlight: 'заявку',
      addSubtitle: 'Зарегистрируйте изделие, сделанное на мастер-классе в Москве, чтобы отслеживать его статус.',
      addNoticeEnabled: 'true',
      addNotice: 'Изделия, сделанные в Суздале, уже учтены — их не нужно добавлять повторно.',
      notFoundText: 'По вашему номеру ничего не найдено. Проверьте данные или свяжитесь с нами:',
      suzdalPhone: '+7 (915) 157-64-85',
      moscowPhone: '+7 (985) 419-89-03',

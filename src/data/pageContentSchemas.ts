...
export const PAGE_SCHEMAS: PageSchema[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      pickupSteps:
        'По окончании мастер-класса заполните короткую форму на странице отслеживания — укажите ФИО, телефон, email и приложите фото изделия.\nПолучите уникальный номер заявки — по нему можно проверить статус изделия в любой момент.\nМенеджер проверит заявку и подтвердит её.\nКак только изделие пройдёт обжиг, на указанный email придёт письмо с датой готовности и сроком хранения.',
